    ...
    <div className="p-3 w-full">
      ...
      <div className="max-w-lg mx-auto p-3 w-full">
        ...
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
          ...
          <img
            src={currentUser.profilePicture || "https://static.vecteezy.com/system/resources/previews/009/292/244/non_2x/default-avatar-icon-of-social-media-user-vector.jpg"} // Replace with your default avatar URL
            alt="user"
