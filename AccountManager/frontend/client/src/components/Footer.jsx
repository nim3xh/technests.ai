...
export default function Footer() {
  return (
    <FlowbiteFooter container={true} className="bg-gray-800 text-white p-6">
      <div className="w-full flex flex-col md:flex-row justify-between items-center">
        <div className="mb-4 md:mb-0">
          <FlowbiteFooter.Title title="Terms of Service" className="text-xl border-b-2 pb-2" />
        ...
        <div className="text-center md:text-right">
          <FlowbiteFooter.Title title="Contact Us" className="text-xl border-b-2 pb-2" />
          <FlowbiteFooter.LinkGroup col={true}>
            <p>1621 Central Avenue</p>
            <p>Cheyenne, WY 82001</p>
            <p>United States</p>
            <p>+1 (925) 315-4786</p>
            <FlowbiteFooter.Link href="mailto:support@blueedgefinancial.com">support@blueedgefinancial.com</FlowbiteFooter.Link>
          </FlowbiteFooter.LinkGroup>
        </div>
      </div>
    </FlowbiteFooter>
