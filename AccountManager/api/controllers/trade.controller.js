        ...
        .then(() => {
            ...
            const formattedTrades = sheetData.map((trade) => {
                return {
                    ...
                    Profit: trade.Profit,
                    UseBreakeven: trade["Use Breakeven"] || false,
                    BreakevenTrigger: trade["Breakeven trigger"] || null,
                    BreakevenOffset: trade["Breakeven Offset"] || null,
                    UseTrail: trade["Use Trail"] || false,
                    TrailTrigger: trade["Trail Trigger"] || null,
                    Trail: trade.Trail || null,
                    TradeTypeId: trade.TradeTypeId || null,
                    Repeat : trade.Repeat || false,
                    RepeatTimes : trade.RepeatTimes || null,
                    RepeatEvery : trade.RepeatEvery || null,
                    ApexId: null,
...
function save(req, res) {
    ...
    .then(() => {
        ...
        const trade = {
            ...
            UseBreakeven: req.body.UseBreakeven || false,
            BreakevenTrigger: req.body.BreakevenTrigger || null,
            BreakevenOffset: req.body.BreakevenOffset || null,
            UseTrail: req.body.UseTrail || false,
            TrailTrigger: req.body.TrailTrigger || null,
            Trail: req.body.Trail || null,
            TradeTypeId: req.body.TradeTypeId,
            Repeat : req.body.Repeat || false,
            RepeatTimes : req.body.RepeatTimes || null,
    ...
    try {
      ...
      const validatedTrades = trades.map((trade, index) => {
        ...
        return {
          ...
          UseBreakeven: trade.UseBreakeven || false,
          BreakevenTrigger: parseFloat(trade.BreakevenTrigger) || null,
          BreakevenOffset: parseFloat(trade.BreakevenOffset) || null,
          UseTrail: trade.UseTrail || false,
          TrailTrigger: parseFloat(trade.TrailTrigger) || null,
          Trail: parseFloat(trade.Trail) || null,
          TradeTypeId: trade.TradeTypeId || null,
          Repeat : trade.Repeat || false,
          RepeatTimes : trade.RepeatTimes || null,
          RepeatEvery : trade.RepeatEvery || null,
...
function saveBulk(req, res) {
    ...
    const formattedTrades = trades.map((trade) => ({
        ...
        Profit: trade.Profit,
        UseBreakeven: trade.UseBreakeven || false,
        BreakevenTrigger: trade.BreakevenTrigger || null,
        BreakevenOffset: trade.BreakevenOffset || null,
        UseTrail: trade.UseTrail || false,
        TrailTrigger: trade.TrailTrigger || null,
        Trail: trade.Trail || null,
        TradeTypeId: trade.TradeTypeId || null,
        Repeat : trade.Repeat || false,
        RepeatTimes : trade.RepeatTimes || null,
